          ...
          <div className="space-y-5 p-5">
            <div className="rounded-2xl bg-slate-800/80 p-4">
              ...
              <div className="mt-5 h-24 rounded-xl bg-gradient-to-r from-emerald-500/20 via-sky-500/10 to-transparent p-3">
                <div className="flex h-full items-end gap-2">
                  {[48, 64, 52, 70, 60, 82, 100].map((height) => (
                    <span
                      key={height}
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              <div className="rounded-2xl bg-slate-800 p-4">
                <div className="text-sm text-slate-300">Income</div>
                <div className="mt-2 text-2xl font-semibold text-white">
                  $8,430
                </div>
              </div>
              <div className="rounded-2xl bg-slate-800 p-4">
                <div className="text-sm text-slate-300">Expenses</div>
                <div className="mt-2 text-2xl font-semibold text-white">
                  $3,210
                </div>
              </div>
